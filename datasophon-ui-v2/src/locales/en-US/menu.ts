export default {
  ...
  'menu.mysql-monitor': 'MySQL Monitor',
  'menu.nexus-monitor': 'Nexus Monitor',
  'menu.datart-monitor': 'DATART Monitor',
  'menu.juicefs-monitor': 'JuiceFS Monitor',
  'menu.kyuubi-monitor': 'Kyuubi Monitor',
