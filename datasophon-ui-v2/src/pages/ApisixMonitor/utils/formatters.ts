...
export function colorByThreshold(value: number, thresholds: Threshold[]): string {
...
export function labelByThreshold(value: number, thresholds: Threshold[]): string | undefined {
  const sorted = [...thresholds]
