...
import { selectionsToRegex } from './utils/promql';
...
const twoDecimalMillisecondFormatter = (value: number) => `${value.toFixed(2)}ms`;
...
const PrometheusDashboard: FC = () => {
  ...
  const variables = useMemo(
    () => ({
      instance: selectedInstances.length > 0 ? selectionsToRegex(selectedInstances) : '.+',
  ...
  return (
    <div className="p-4" key={refreshKey}>
      ...
      <Row gutter={ROW_GUTTER} style={{ marginBottom: 16 }}>
        ...
        <Col span={4}>
          <StatPanel
            ...
            color={colorByThreshold(instant.totalSeries, [
              1_000_000,
              2_000_000,
            ])}
        ...
        <Col span={4}>
          <StatPanel
            title={t('pages.prometheusMonitor.panel.reloadFailures', { interval })}
        ...
        <Col span={4}>
          <StatPanel
            title={t('pages.prometheusMonitor.panel.missedIterations', { interval })}
        ...
        <Col span={4}>
          <StatPanel
            title={t('pages.prometheusMonitor.panel.skippedScrapes', { interval })}
      ...
      <Row gutter={ROW_GUTTER} style={{ marginBottom: 16 }}>
        <Col span={8}>
          <TablePanel title={t('pages.prometheusMonitor.panel.currentlyDown')} data={down} />
        </Col>
        <Col span={16}>
          <AreaPanel
