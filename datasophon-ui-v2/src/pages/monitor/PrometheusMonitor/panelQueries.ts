...
export const PANEL_QUERIES: Record<string, PanelDef> = {
  ...
  P17: {
    ...
    queries: [
      ...
      {
        label: 'sys',
        promql: 'sum(go_memstats_sys_bytes{job=~"$job",instance=~"$instance"})',
      },
    ],
  },
  P18: {
...
// TIME_RANGE_SECONDS 已移至 ../_shared/panelTypes，此处 re-export 保持兼容
export { TIME_RANGE_SECONDS } from '../_shared/panelTypes';
