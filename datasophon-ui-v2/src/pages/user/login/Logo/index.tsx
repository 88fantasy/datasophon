      ...
      <div className="relative w-full max-w-2xl aspect-square flex items-center justify-center">
        <svg viewBox="0 0 400 400" className="w-full h-full" aria-label="Datasophon Logo">
          ...
          <g
            ...
            onClick={() => analyze('KUBERNETES')}
          >
            <g
              transform="translate(182, 42) scale(0.9)"
              stroke="#3b82f6"
              strokeWidth="2.2"
              fill="none"
            ...
            >
              ...
              <path
                d="M20 2v8M20 30v8M4 14l6 3M30 23l6 3M7 32l5-5M28 13l5-5M35 15l-7 4"
                strokeLinecap="round"
              />
            ...
            <text
              ...
              y="30"
              textAnchor="middle"
              className="fill-slate-500 font-bold text-[10px] tracking-[1.5px]"
            >
              KUBERNETES
            </text>
          </g>
          ...
          <g
            className="cursor-pointer group"
            onClick={() => analyze('SERVICES')}
          >
            <g
              transform="translate(325, 185) scale(0.9)"
              fill="none"
              stroke="#10b981"
              strokeWidth="2.5"
              className="transition-transform duration-300"
          ...
          <g
            className="cursor-pointer group"
            onClick={() => analyze('CONTAINERS')}
          >
            <g
              transform="translate(180, 325) scale(1)"
              fill="none"
              stroke="#6366f1"
              strokeWidth="2.2"
              className="transition-transform duration-300"
          ...
          <g
            className="cursor-pointer group"
            onClick={() => analyze('ARTIFACTS')}
          >
            <g
              transform="translate(45, 182) scale(0.9)"
              fill="none"
              stroke="#f59e0b"
              strokeWidth="2.5"
              className="transition-transform duration-300"
          ...
          {/* CENTER CORE */}
          <g
            className="center-group cursor-pointer"
            onClick={() => analyze('DataSophon Core')}
          >
            <g
              transform="translate(175, 175) scale(1.25)"
              fill="none"
              stroke="url(#mainGrad)"
              strokeWidth="2.5"
            >
