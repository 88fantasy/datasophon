...
public abstract class ServiceHandler {
    ...
    public ServiceHandler() {
        configService = Application.getBean(K8sClusterConfigService.class);
        k8sService = Application.getBean(K8sService.class);
        instanceService = Application.getBean(K8sServiceInstanceService.class);
        commandService = Application.getBean(ClusterK8sServiceCommandService.class);
    }
