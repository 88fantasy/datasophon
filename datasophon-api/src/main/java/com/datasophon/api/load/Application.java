...
public class Application implements ApplicationContextAware {
    ...
    @Deprecated
    /*
     * public static NexusRegistry getNexus() { NexusRegistry nexusRegistry = new NexusRegistry(); nexusRegistry.setEnable(Constants.NEXUS_ENABLE); host.setIp(getProperty("nexus.ip"));
     * NexusRegistry.Config config = new NexusRegistry.Config(); config.setWebPort(getProperty("nexus.port")); config.setUser(getProperty("nexus.user"));
     * config.setPassword(getProperty("nexus.password")); nexusRegistry.setNode(host); nexusRegistry.setConfig(config); return nexusRegistry; }
     */
