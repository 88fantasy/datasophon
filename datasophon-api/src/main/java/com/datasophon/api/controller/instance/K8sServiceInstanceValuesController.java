...
public class K8sServiceInstanceValuesController extends ApiController {
    ...
    @ApiResponse(content = {
            @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = K8sServiceInstanceValues.class)))
    })
    @UserPermission
    ...
    @ApiResponse(content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = K8sServiceInstanceValues.class))
    })
    @UserPermission
    ...
    @ApiResponse(content = {
            @Content(mediaType = "application/json", schema = @Schema(implementation = K8sServiceInstanceValuesVO.class))
    })
    @UserPermission
