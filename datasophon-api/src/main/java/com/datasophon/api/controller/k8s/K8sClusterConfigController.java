...
public class K8sClusterConfigController extends ApiController {
    ...
    @ApiResponse(
            content = {@Content(mediaType = "application/json", schema = @Schema(implementation = K8sConnectionResult.class))}
    )
    ...
    @ApiResponse(
            content = {@Content(mediaType = "application/json", schema = @Schema(implementation = K8sClusterConfig.class))}
    )
    @UserPermission
