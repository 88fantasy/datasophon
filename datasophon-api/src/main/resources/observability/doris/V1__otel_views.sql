...
CREATE MATERIALIZED VIEW otel_logs_services AS
...
CREATE MATERIALIZED VIEW otel_metrics_services AS
SELECT service_name, service_instance_id
...
CREATE MATERIALIZED VIEW otel_traces_services AS
