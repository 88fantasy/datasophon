...
start(){
  ...
  exec_command="$SH_DIR/prometheus --config.file=prometheus.yml --web.listen-address=:9090 --web.enable-lifecycle --storage.tsdb.retention.time=30d --storage.tsdb.path=/data/prometheus/data/"
