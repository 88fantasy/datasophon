...
start(){
  ...
  if [ $command = "hiveserver2" ]
  then
      /data/install_datasophon/hadoop-3.3.3/bin/hdfs dfs -mkdir -p /user/hive/warehouse
      /data/install_datasophon/hadoop-3.3.3/bin/hdfs dfs -chmod g+w /user/hive/warehouse
  fi
