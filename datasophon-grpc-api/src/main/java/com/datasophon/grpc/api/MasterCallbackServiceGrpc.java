 ...
 * </pre>
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.68.1)", comments = "Source: master.proto")
...
public final class MasterCallbackServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.datasophon.grpc.api.OlapRegistrationRequest, com.datasophon.grpc.api.OlapRegistrationResponse> getRegisterOlapNodeMethod;
    
    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "RegisterOlapNode", requestType = com.datasophon.grpc.api.OlapRegistrationRequest.class, responseType = com.datasophon.grpc.api.OlapRegistrationResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.datasophon.grpc.api.OlapRegistrationRequest, com.datasophon.grpc.api.OlapRegistrationResponse> getRegisterOlapNodeMethod() {
    ...
    public static final class MasterCallbackServiceStub
            extends
                io.grpc.stub.AbstractAsyncStub<MasterCallbackServiceStub> {
    ...
    public static final class MasterCallbackServiceBlockingStub
            extends
                io.grpc.stub.AbstractBlockingStub<MasterCallbackServiceBlockingStub> {
    ...
    public static final class MasterCallbackServiceFutureStub
            extends
                io.grpc.stub.AbstractFutureStub<MasterCallbackServiceFutureStub> {
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(
                                new MethodHandlers<com.datasophon.grpc.api.OlapRegistrationRequest, com.datasophon.grpc.api.OlapRegistrationResponse>(
