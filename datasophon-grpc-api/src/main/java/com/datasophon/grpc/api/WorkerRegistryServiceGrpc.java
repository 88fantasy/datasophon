 ...
 * </pre>
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.68.1)", comments = "Source: registry.proto")
...
public final class WorkerRegistryServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.datasophon.grpc.api.RegisterRequest, com.datasophon.grpc.api.RegisterResponse> getRegisterMethod;
    
    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "Register", requestType = com.datasophon.grpc.api.RegisterRequest.class, responseType = com.datasophon.grpc.api.RegisterResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.datasophon.grpc.api.RegisterRequest, com.datasophon.grpc.api.RegisterResponse> getRegisterMethod() {
    ...
    private static volatile io.grpc.MethodDescriptor<com.datasophon.grpc.api.HeartbeatRequest, com.datasophon.grpc.api.HeartbeatResponse> getHeartbeatMethod;
    
    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "Heartbeat", requestType = com.datasophon.grpc.api.HeartbeatRequest.class, responseType = com.datasophon.grpc.api.HeartbeatResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.datasophon.grpc.api.HeartbeatRequest, com.datasophon.grpc.api.HeartbeatResponse> getHeartbeatMethod() {
    ...
    private static volatile io.grpc.MethodDescriptor<com.datasophon.grpc.api.UnregisterRequest, com.datasophon.grpc.api.UnregisterResponse> getUnregisterMethod;
    
    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "Unregister", requestType = com.datasophon.grpc.api.UnregisterRequest.class, responseType = com.datasophon.grpc.api.UnregisterResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.datasophon.grpc.api.UnregisterRequest, com.datasophon.grpc.api.UnregisterResponse> getUnregisterMethod() {
    ...
    public static final class WorkerRegistryServiceStub
            extends
                io.grpc.stub.AbstractAsyncStub<WorkerRegistryServiceStub> {
    ...
    public static final class WorkerRegistryServiceBlockingStub
            extends
                io.grpc.stub.AbstractBlockingStub<WorkerRegistryServiceBlockingStub> {
    ...
    public static final class WorkerRegistryServiceFutureStub
            extends
                io.grpc.stub.AbstractFutureStub<WorkerRegistryServiceFutureStub> {
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(
                                new MethodHandlers<com.datasophon.grpc.api.RegisterRequest, com.datasophon.grpc.api.RegisterResponse>(
                                        service, METHODID_REGISTER)))
                .addMethod(
                        getHeartbeatMethod(),
                        io.grpc.stub.ServerCalls.asyncUnaryCall(
                                new MethodHandlers<com.datasophon.grpc.api.HeartbeatRequest, com.datasophon.grpc.api.HeartbeatResponse>(
                                        service, METHODID_HEARTBEAT)))
                .addMethod(
                        getUnregisterMethod(),
                        io.grpc.stub.ServerCalls.asyncUnaryCall(
                                new MethodHandlers<com.datasophon.grpc.api.UnregisterRequest, com.datasophon.grpc.api.UnregisterResponse>(
