...
public class KerberosActor extends HookTypedActor<GenerateKeytabFileCommand> {
    
    private static final Logger logger = LoggerFactory.getLogger(KerberosActor.class);

    @Override
    protected void doOnReceive(GenerateKeytabFileCommand command) throws Throwable {
