...
root_url = %(protocol)s://%(domain)s:%(http_port)s/ddh/grafana/
...
# List the links id's to use here, Grafana will look for matching links configurations
...
# For Grafana Cloud Loki you need to include your credentials in the URL (user:api-key@host:port)
# Example: url = 13811:eyJrIjoiMTM5@logs-prod-us-central1.grafana.net
url = localhost:9095
...
[feature_highlights]
# Enable or disable the feature highlights functionality
enabled = false
