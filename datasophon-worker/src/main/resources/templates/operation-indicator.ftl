...
spring:
  datasource:
    username: ${operationDbIndicatorUsername}
    password: ${operationDbIndicatorPassword}
    driver-class-name: ${operationDbIndicatorDriverClassName}
    url: ${operationDbIndicatorUrl}
