...
start(){
  ...
  exec_command="$SH_DIR/elasticsearch_exporter --es.all --es.indices --collector.clustersettings --es.indices_settings --es.shards --collector.snapshots --es.timeout=10s --web.listen-address=:${esExporterPort} --web.telemetry-path=/metrics --es.uri http://elastic:dafU%26%25Ukabm12@${"$"}{HOSTNAME}:9200"
