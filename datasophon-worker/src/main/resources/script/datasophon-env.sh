...
export JAVA_HOME17=/usr/local/jdk17
export JAVA_HOME21=/usr/local/jdk21
...
export SEATUNNEL_HOME=/data/install_datasophon/seatunnel
export HADOOP_HOME=/data/install_datasophon/hadoop
export HADOOP_CONF_DIR=/data/install_datasophon/hadoop/etc/hadoop
export PATH=$PATH:$JAVA_HOME/bin:$SPARK_HOME/bin:$HADOOP_HOME/bin:$HIVE_HOME/bin:$FLINK_HOME/bin:$SEATUNNEL_HOME/bin:$KAFKA_HOME/bin:$HBASE_HOME/bin
