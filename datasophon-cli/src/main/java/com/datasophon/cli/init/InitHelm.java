...
@Data
@CommandLine.Command(name = "helm", description = "init helm")
public class InitHelm extends InitBase implements InitNodeHandler {
    ...
    public boolean doRun(Executor executor) {
        ...
        Boolean isInstalled;
        isInstalled = executor.execShell("helm version").getExecResult();
        if(isInstalled) {
            log.info("helm is installed");
            return true;
        }
        ...
        String softPath = String.format("%s/helm", installPath);
