...
${JAVA_HOME}/bin/java -jar ${INIT_SBIN_PATH}/datasophon-cli-cli.jar create cluster --onlyInstallK8s --enableRegistry -cpwd ${PASSWORD} --productPackagesPath /data/packages -p /data/datasophon -in /data/install_datasophon -a initALL