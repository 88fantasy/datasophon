...
| 2026-08-06 | 本地仓库 | 新建独立 Maven 模块 `datasophon-lineage-emitter/`（T10/T11 血缘发射器源码，pom.xml + 8 个 Java 源文件），本机 `mvn compile` 已跑通，**未打包未部署** | 已 checked-in（源码，无凭据） | `rm -rf datasophon-lineage-emitter/` |
