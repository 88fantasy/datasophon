...
| 5  | [ ] | 🟠  | GlobalVariables 内存写移到 afterCommit         | `ProcessUtils:362`、`ServiceInstallServiceImpl:101`                                 | 局部        |
| 6  | [ ] | 🟠  | 循环内 gRPC fan-out 并行                       | `ProcessUtils:375/614`                                                             | 局部        |
| 7  | [ ] | 🟠  | Physical/K8s Install N+1 + 重复查/解析         | `PhysicalProductInstallServiceImpl:313/279/745`、`K8SProductInstallServiceImpl:403` | 中等        |
| 8  | [ ] | 🟠  | WorkerCommandClient.getStub 校验 Channel 状态 | `WorkerCommandClient:358/274`                                                      | 局部        |
| 9  | [ ] | 🟠  | 抽 afterCommit 模板方法消除复制粘贴                  | `PhysicalProductInstallServiceImpl:244/629/701`                                    | 快赢·纯抽取    |
| 10 | [ ] | 🟠  | 字段注入 → 构造器注入(分批)                          | 303 处,4 大 Impl 起步                                                                  | 机械·量大     |
| 11 | [ ] | 🟠  | 拆分 ProcessUtils god class                 | `ProcessUtils.java`(706/27 static)                                                 | 结构重构      |
